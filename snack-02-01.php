...
$n_ads = count($ads);
do {
	$random_index = rand(0, $n_ads - 1);
} while (!$ads[$random_index]['is_active']); ?>
...
<body>
	<h1><?= $ads[$random_index]['is_active'] ? 'ACTIVE' : 'INACTIVE' ?></h1>
	<a href="<?= $ads[$random_index]['link'] ?>"><img src="<?= $ads[$random_index]['image_path'] ?>"></a>
</body>
</html>
